...
// File             : RedisDistributedCacheProvider.cs
// Created          : 2026-07-13  11:07
// 
// Last Modified By : kitt-nostalgic(jstsmaxx@gmail.com)
// Last Modified On : 2026-07-15  14:44
// ****************************************************************************************************************************************
// <copyright file="RedisDistributedCacheProvider.cs" company="">
...

{
...

    {
        ...
        byte[] utf8 = (byte[])value!;

        return JsonSerializer.Deserialize<T>((ReadOnlySpan<byte>)utf8, _serializerOptions);
    }
...

    {
        ...
        {
            byte[] utf8 = (byte[])existing!;

            T? cached = JsonSerializer.Deserialize<T>((ReadOnlySpan<byte>)utf8, _serializerOptions);
