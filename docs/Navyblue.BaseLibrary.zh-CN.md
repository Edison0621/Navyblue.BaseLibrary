...
- 基础库支持 `net6.0`、`net7.0`、`net8.0`、`net9.0`、`net10.0`。
- Core 和 AspNetCore 项目复用 `Navyblue.BaseLibrary.Extensions` 中的扩展方法。
...
内置能力包括全局异常映射、TraceId 透传、租户解析、安全响应头、请求日志、审计日志、Minimal API 标准返回和健康检查端点。
## 测试辅助
